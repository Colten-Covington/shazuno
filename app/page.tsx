      ...
      <div className="container mx-auto px-4 py-8">
        <header className="text-center mb-12">
          <div className="flex items-center justify-center gap-4 mb-4">
            ...
            >
              <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" role="img">
                <title>GitHub</title>
          ...
          >
            <div className="flex items-start justify-between gap-4 mb-4">
              ...
              <button
                type="button"
                onClick={() => setActiveSong(null)}
                className="text-gray-300 hover:text-white focus:outline-none focus:ring-2 focus:ring-white rounded px-3 py-1"
                aria-label="Close lyrics modal"
              >
                <span aria-hidden="true">✕</span> Close
              </button>
            </div>
            <div className="bg-black/40 rounded-lg p-4 overflow-y-auto whitespace-pre-wrap text-sm text-gray-200" role="document" tabIndex={0}>
              {(activeSong.lyrics || '')
                .replace(/\r\n/g, '\n')
                .replace(/\/n/g, '\n')}
            </div>
